...
/**
 * Filas al estilo Marketing API para la tabla de Meta Ads en /dashboard/campanas (solo modo demo).
 * Números alineados con `mockCampaigns` donde `platform === "meta"`.
 */
export const demoMetaAdsCampaignRows: MetaCampaignRow[] = [
  {
    id: "demo-meta-1",
    name: "Verano — Conversión",
    status: "ACTIVE",
    objective: "Ventas",
    currency: "ARS",
    spend: 4200,
    ...
    cpm: 22.11,
    conversions: 118,
    cost_per_conversion: 35.59,
    purchases: 112,
    conversion_value: 13100,
    roas: 3.12,
  },
  {
    id: "demo-meta-2",
    name: "Remarketing carrito",
    status: "ACTIVE",
    objective: "Ventas",
    currency: "ARS",
    spend: 2100,
  ...
  },
  {
    ...
    cpm: 20.0,
    conversions: 203,
    cost_per_conversion: 27.59,
    purchases: 198,
    conversion_value: 21100,
    roas: 3.77,
  },
  {
    id: "demo-meta-5",
    name: "Cold traffic LATAM",
    status: "ACTIVE",
    objective: "Tráfico",
    currency: "ARS",
    spend: 4900,
    ...
    cpm: 20.42,
    conversions: 141,
    cost_per_conversion: 34.75,
    purchases: 135,
    conversion_value: 13775,
    roas: 2.81,
  },
];
