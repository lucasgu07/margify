...
export const landingGlassNav =
  "isolate border border-teal-950/45 bg-[rgba(10,46,46,0.86)] shadow-[0_12px_40px_rgba(0,0,0,0.38)] backdrop-blur-[40px] [-webkit-backdrop-filter:blur(40px)] backdrop-saturate-150";
