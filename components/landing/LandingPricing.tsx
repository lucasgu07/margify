    ...
    <div className="mx-auto max-w-6xl px-4 md:px-6">
      ...
      <div className="mx-auto mt-10 grid max-w-6xl max-md:grid-cols-2 max-md:gap-3 items-stretch gap-6 md:grid-cols-3 md:gap-6 lg:gap-8">
        ...
        <Card className={planCardClass}>
          ...
          <Link
            href="/auth/register"
            className={buttonClassName("secondary", "mt-auto block w-full pt-6 text-center max-md:pt-4")}
          >
            Empezar
          </Link>
        </Card>
        ...
        >
          ...
          <Link
            href="/auth/register"
            className={buttonClassName("primary", "mt-auto block w-full pt-6 text-center max-md:pt-4")}
          >
            Elegir Pro
          </Link>
        </Card>

        {/* Scale — max-md: fila de abajo centrada (triángulo 2+1) */}
        <Card
          className={cn(
            planCardClass,
